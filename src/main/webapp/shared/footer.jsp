<footer class="bg-dark text-light py-5">
    <div class="container">
        <div class="row g-4">
            <div class="col-md-4">
                <h5 class="mb-3">About ProServices</h5>
                <p class="text-muted">Connecting professionals with clients, making service hiring simple and reliable.</p>
        ...
        <div class="row align-items-center">
            <div class="col-md-6 text-center text-md-start">
                <p class="mb-0 text-muted">&copy; 2024 ProServices. All rights reserved.</p>
            </div>
